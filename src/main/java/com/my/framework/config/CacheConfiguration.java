...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.my.framework.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.my.framework.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.my.framework.domain.District.class.getName());
